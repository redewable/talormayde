...
export default function About() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white pt-32 px-6 pb-20 relative overflow-hidden font-sans selection:bg-white selection:text-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="mb-32 text-center md:text-left">
            ...
            >
                ...
                <div className="max-w-2xl text-lg md:text-xl text-zinc-400 font-light leading-relaxed space-y-6">
                    <p>
                        <strong className="text-white font-normal">Talormayde</strong> is an interdisciplinary atelier positioned at the intersection of design, technology, and art.
                    </p>
                    <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-white/5 pt-20 mb-32">
            {[
                ...
                <motion.div 
                    ...
                    className="group"
                >
                    <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mb-6 text-zinc-400 group-hover:text-white group-hover:bg-white/10 transition-all">
                        <item.icon strokeWidth={1} size={20} />
                    </div>
                    <h3 className="text-lg font-light text-white mb-4 uppercase tracking-widest">{item.title}</h3>
